...
describe("redactGitHubTokens", () => {
  it("redacts an installation token URL", () => {
    const input =
      "git push https://x-access-token:ghs_59Ucut5A2Jjogta2OzN7hOMzuAmkf33DGpmv@github.com/707-Labs/ertai.git ERT-1583";
  ...
  it("does not match bare token-looking strings outside the URL prefix", () => {
    const input = "ghs_59Ucut5A2Jjogta2OzN7hOMzuAmkf33DGpmv is a token";
    expect(redactGitHubTokens(input)).toBe(input);
  });
